...
role: Flutter Architect and AI-native product developer
core_strengths:
  - Clean Architecture
  - MVVM
  - Repository Pattern
...
- refactor safely with clearer context
...
- Production-grade Flutter application architecture
...
If you are checking this profile, the main idea is simple:
...
If you want to build a serious mobile product, improve an existing Flutter codebase, or work with someone who is already adapting to AI-driven development, reach out.
